...
type CastingSpec struct {
	...
	// Patches are JSON Patch (RFC 6902) operations applied to generated output files.
	Patches []PatchEntry `json:"patches,omitempty" yaml:"patches,omitempty" description:"JSON Patch (RFC 6902) operations to apply to generated materials"`
...
type PatchEntry struct {
	...
	Type string `json:"type,omitempty" yaml:"type,omitempty" description:"Patch driver type (jsonpatch). Defaults to jsonpatch."`

	// Target is the output file to patch, relative to the pours directory.
	Target string `json:"target,omitempty" yaml:"target,omitempty" description:"Target output file to patch"`

	// Operations is a list of JSON Patch (RFC 6902) operations to apply.
	Operations []PatchOperation `json:"operations,omitempty" yaml:"operations,omitempty" description:"JSON Patch (RFC 6902) operations to apply"`
}
...
type PatchOperation struct {
	...
	Op string `json:"op" yaml:"op" description:"Operation type (add, remove, replace, move, copy, test)"`

	// Path is a JSON Pointer (RFC 6902) to the target location.
	Path string `json:"path" yaml:"path" description:"JSON Pointer to the target location"`
	...
	From string `json:"from,omitempty" yaml:"from,omitempty" description:"Source JSON Pointer for move and copy operations"`
}
