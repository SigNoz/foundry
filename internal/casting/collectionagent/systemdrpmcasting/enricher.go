...
var _ collectionagentmolding.MoldingEnricher = (*systemdRPMMoldingEnricher)(nil)

type systemdRPMMoldingEnricher struct{}

func newSystemdRPMMoldingEnricher() *systemdRPMMoldingEnricher {
	return &systemdRPMMoldingEnricher{}
}

func (e *systemdRPMMoldingEnricher) EnrichStatus(ctx context.Context, kind v1alpha1.MoldingKind, config *collectionagent.Casting) error {
