...
var _ collectionagentmolding.MoldingEnricher = (*kubernetesHelmMoldingEnricher)(nil)

type kubernetesHelmMoldingEnricher struct{}

func newKubernetesHelmMoldingEnricher() *kubernetesHelmMoldingEnricher {
	return &kubernetesHelmMoldingEnricher{}
}

func (e *kubernetesHelmMoldingEnricher) EnrichStatus(ctx context.Context, kind v1alpha1.MoldingKind, config *collectionagent.Casting) error {
