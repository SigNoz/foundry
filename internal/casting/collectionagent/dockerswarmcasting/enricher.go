...
var _ collectionagentmolding.MoldingEnricher = (*dockerSwarmMoldingEnricher)(nil)

type dockerSwarmMoldingEnricher struct{}

func newDockerSwarmMoldingEnricher() *dockerSwarmMoldingEnricher {
	return &dockerSwarmMoldingEnricher{}
}

func (e *dockerSwarmMoldingEnricher) EnrichStatus(ctx context.Context, kind v1alpha1.MoldingKind, config *collectionagent.Casting) error {
