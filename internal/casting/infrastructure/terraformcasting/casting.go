...
// Forge renders the terraform materials for the provisioned infrastructure.
// Scaffolding: rendering lands with the provision templates.
...
// Cast applies the forged terraform and captures its outputs.
// Scaffolding: applying lands with the forge implementation.
