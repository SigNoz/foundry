...
docs:
	...
	go run go.opentelemetry.io/build-tools/gotmpl@latest -b README.md.gotmpl -d "$$(cat docs/examples/castings.json)" -o README.md
	go run go.opentelemetry.io/build-tools/gotmpl@latest -b docs/examples/README.md.gotmpl -d "$$(cat docs/examples/castings.json)" -o docs/examples/README.md
